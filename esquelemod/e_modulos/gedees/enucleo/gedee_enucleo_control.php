...
/**
   ...
   */	
		...
		$La_fich_interfaz_config_gedee_nucleo['Ls_pathfich_interfaz'] = 'hereda' ;
	        $La_fich_datos_config_gedee_nucleo['Ls_pathfich_datos'] = 'gedee_configuracion.cnf' ;
	        $La_fich_datos_config_gedee_nucleo['Ls_path_base'] = self::$EEoNucleo->pathDirEsquelemod().'/e_modulos/'.self::$lsPathDirRaizEntidades.'/'.'enucleo' ;
