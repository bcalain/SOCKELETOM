...
/**
   ...
   * @author Oscar Luis Inguanzo <oscarlim@nauta.cu> I added the option of taking comments into account 
   * @link https://github.com/mustangostang/spyc/
   * @copyright Copyright 2005-2006 Chris Wanstrath, 2006-2011 Vlad Andersen, 2016 Oscar Luis Inguanzo
   * loadFile(), __load(), YAMLLoad()
...
class Spyc {
  ...
  /**
   * Setting this to true will forse YAMLLoad to not to discard the commented 
   * lines. False by default.
   * 
   * @author Oscar Luis Inguanzo <oscarlim@nauta.cu>
   * @var bool
   * @access private
   */
  private $setting_comment = false;
 ...
 * @return array
 *
 * @param bool $showComment Force to discard (or not) the comments
 */
  public function loadFile ($file,$showComment=false) {
    return $this->__load($file,$showComment);
  }
  ...
  /**
     ...
     * @param bool $showComment Force to discard (or not) the comments. @author Oscar Luis Inguanzo <oscarlim@nauta.cu>
     */
  public static function YAMLLoad($input,$showComment = false) {
    $Spyc = new Spyc;
    return $Spyc->__load($input,$showComment);
  }
 ...
 * 
 * @param type $input
 * @param type $showComment Force to discard (or not) the comments
 * 
 */
  private function __load($input,$showComment=false) {
    $this->setting_comment = $showComment;
