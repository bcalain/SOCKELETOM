...
/**
   ...
   */	
    ...
    //seccion inicializacion de los objetos del nucleo que presizan inicializacion
        ...
        $EEoInterfazDatos->iniciacionImplementacionInterfazDatos( $EEoNucleo->pathDirEsquelemod().'/e_modulos/interfaz_datos/yaml/e_interfaz_datos_yaml.php' , 'adyacente' , $EEoNucleo->pathDirEsquelemod().'/e_statu_procesos' );
    ...
    //seccion carga de configuracion del sistema esquelemod
        ...
        $La_fich_interfaz_config['Ls_pathfich_interfaz'] = 'e_modulos/interfaz_datos/yaml/e_interfaz_datos_yaml.php' ;
	    $La_fich_interfaz_config['Ls_path_base'] = $EEoNucleo->pathDirEsquelemod() ;
	    $La_fich_datos_config['Ls_pathfich_datos'] = 'e_sistema/e_sistema_config.cnf' ;
	    $La_fich_datos_config['Ls_path_base'] = $EEoNucleo->pathDirEsquelemod() ;
