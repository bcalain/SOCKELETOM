<!--
Cuadro de "Agregar Bloque de Procesos" de "Valores referentes a bloques de procesos" del fichero de configuración
-->
<div class="modal-body">
    <div class = "panel-body">
        ...
        <table width="100%">
            <tr><td align="right">&numsp;&numsp;Nombre:</td><td>&numsp;<div class="col-lg-10"><input class="form-control input-sm" type="text" name="datosAddBloque" value="" autofocus/></div></td></tr>
            <tr><td>
                </td></tr>
