...
*/
/**
   * eid_txt_mono_array_erouter script
   * @version 0.0.1
   ...
   */	
	...
	$La_datos_complementarios['La_estructura_filtro']['url_entrada_virtual'] = $La_datos_complementarios['Ls_identificador_objeto_gestion'] ;
	$La_datos_complementarios['La_estructura_llaves_base'] = $La_datos_complementarios['secciones_nomenclador'] ;
	...
	if( !empty( $La_datos_result[0] ) )
		{
			return $La_datos_result[0] ; 
		}
	else 
		{ 
			trigger_error('No se ha gestionado el string objeto de la gesti&oacute;n del parser eid_txt_mono_array_erouter ', E_USER_WARNING );
		}	
